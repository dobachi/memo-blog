...
#
# 2つ目は**パーマリンクの番人**。:year/:month/:day はシステムのタイムゾーンで決まり、
# _config.yml の `timezone: Japan` はこれを制御しない。TZ が UTC だと日本時間で
# 09:00 より前の記事が1日前にずれ、既存URLが全て404になる（2026-08-09 に実際に起きた）。
# ずれるとこのパスが消えるので、そこで止まる。
REQUIRED = [
    "index.html",
    "2026/07/19/Apache-Iceberg-and-REST-Catalog-hands-on/index.html",
]
